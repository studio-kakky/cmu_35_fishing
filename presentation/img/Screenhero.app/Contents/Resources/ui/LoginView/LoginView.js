var LoginView = new function () {
	...
	self.connectionTimeout = 30 * 1000;
	...
	this.Initialize = function() {
		...
		self.ra.on('liveStatusLinkClicked', function (evt) {
			JSToNativeBridge.CallNativeFunction("LaunchUrlInBrowser", "https://screenhero.com/status.html");
		});
    ...
    this.setServerStatus = function(serverStatus) {
    	if (!serverStatus.isAlive && serverStatus.message == "") serverStatus.message = "Screehero's servers are down";
    	self.ra.set("serverStatus", serverStatus);
    }
}

    ...
    */
    ...
    _changeConnectStatus: function (status, condition)
    {
        ...
        if (this.connect_callback) {
            try {
                this.connect_callback(status, condition, this);
            } catch (e) {
     ...
     */
    _doDisconnect: function (didReceiveEndOfStream)
    {
        ...
        this._changeConnectStatus(Strophe.Status.DISCONNECTED, didReceiveEndOfStream ? "didReceiveEndOfStream" : null);
        this.connected = false;
    },
...
Strophe.Websocket.prototype = {
    ...
    _check_streamerror: function (bodyWrap, connectstatus) {
        var errors = $("stream\\:error, bodyWrap", bodyWrap);
        if (errors.length === 0) {
            return false;
        }
        var error = errors[0];
